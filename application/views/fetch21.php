...
<table class="table table-dark">
  ...
  <?php foreach($ftc as $row){?>
    <tr>
      ...
      <td><a href="<?php echo base_url();?>hello/edit21/<?php echo $row['id']?>" class="btn btn-success">Edit</a>&nbsp;&nbsp;<a href="<?php echo base_url();?>hello/delete/<?php echo $row['id']?>" class="btn btn-danger"  onclick='confirm("Press a button!");'>Delete</a></td>
    </tr>
   <?php } ?> 
  </tbody>
</table>
